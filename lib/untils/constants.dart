...
String kSignUps = "/Screens/User/AUTH/signUps.dart";
String kSignIns = "/Screens/User/AUTH/sign_in.dart";
...
String kDashboardScreen = "/Screens/dashboard.dart";
// Services
String kServicesScreen = "/Screens/Services/services_list.dart";
String kPostIssuesScreen = "/Screens/Services/post_issues.dart";
// export 'package:political/Screens/Services/post_issues.dart';
// export 'package:political/Screens/dashboard.dart';
//
////////// Fonts Size
...
///# Political
///
const Color KPartyThemeOne = Color(0xffFB793B);
const Color KPartyThemetwo = Color(0xff00A54F); //#
...
const Color KDarkPink_twg = Color(0xffC23FAC);
...
// /
const Color KBJPOrange = Color(0xffF97D09);
